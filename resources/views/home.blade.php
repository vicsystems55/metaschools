...
@section('content')
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item carousel-box active"
                            style="background-image:url('images/home/home-5/img-1.jpg'); background-position: center; background-repeat: no-repeat;">
                        ...
                        <div class="carousel-item carousel-box"
                            style="background-image:url('images/home/home-5/img-2.jpg'); background-position: bottom; background-repeat: no-repeat;">
                            <div class="bg-overlay"></div>
                            <div class="home-center">
                                <div class="home-desc-center">
                                    <div class="container">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="home-content text-center text-white">
                                                    ...
                                                    <p class="home-4-desc text-white-50 mt-4 f-15">A digital web design
                                                        ...
                                                        large language ocean It has roots in a piece of classical Latin
                                                        literature accusantium doloremque laudantium.</p>
                                                    <div class="mt-4 pt-2">
                                                        <a href=""
                                                            class="btn btn-outline-primary btn-rounded mr-3">Contact
                        ...
                        <div class="carousel-item carousel-box"
                            style="background-image:url('images/home/home-5/img-3.jpg'); background-position: bottom; background-repeat: no-repeat;">
                            <div class="bg-overlay"></div>
                            <div class="home-center">
                                <div class="home-desc-center">
                                    <div class="container">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="home-content text-center text-white">
                                                    ...
                                                    <p class="home-4-desc text-white-50 mt-4 f-15">A digital web design
                                                        studio creating modern & engaging online.
                                                        Separated they live in Bookmarksgrove right the Semantics, a
                                                        large language ocean randomised words which don't look even
                ...
                <div class="col-lg-12">
                    <div class="client-slider text-center">
                        <div class="tiny-slide">
                            <img src="images/clients/logo1.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo2.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo3.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo4.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo5.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo6.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo7.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo8.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo9.png" alt="" class="img-fluid">
                        </div>
                        <div class="tiny-slide">
                            <img src="images/clients/logo10.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <!--end client-slider-->
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mt-4 pt-2">
                    <div class="service-box text-center text-lg-start">
                        <div class="service-image">
                            <img src="images/service/img-1.png" alt="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 mt-4 pt-2">
                    <div class="service-box text-center text-lg-start">
                        <div class="service-image">
                            <img src="images/service/img-2.png" alt="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 mt-4 pt-2">
                    <div class="service-box text-center text-lg-start">
                        <div class="service-image">
                            <img src="images/service/img-3.png" alt="img-fluid">
                        </div>
    ...
    <section class="section " id="features">
                ...
                <div class="col-lg-7">
                    <div class="sec-image position-relative " id="sec-image">
                        <div class="bg-img overflow-hidden border-radius">
                            <img src="images/features/img-1.png" alt="" class="img-fluid">
                        </div>
                        <div class="youtube-icon ">
                            <a href="#watchvideomodal1" data-bs-toggle="modal">
                                <img src="images/features/youtube.png" alt="" class="img-fluid">
                            </a>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 offset-lg-1 order-1 order-lg-2">
                        <div class="sec-image-2 position-relative " id="sec-image-2">
                            <div class="bg-img overflow-hidden border-radius">
                                <img src="images/features/img-2.png" alt="" class="img-fluid">
                            </div>
        ...
        <div class="modal fade bd-example-modal-lg" id="watchvideomodal1" data-keyboard="false" tabindex="-1"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog modal-lg">
                <div class="modal-content hero-modal-0 bg-transparent">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <video id="VisaChipCardVideo09" class="w-100" controls="">
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="d-flex align-items-center mt-4 pt-3">
                            <div class="flex-shrink-0">
                                <div class="user-image">
                                    <img src="images/users/img-1.jpg" alt="" class="avatar-lg rounded-circle">
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide border-radius">
                        ...
                        <div class="d-flex align-items-center mt-4 pt-3">
                            <div class="flex-shrink-0">
                                <div class="user-image">
                                    <img src="images/users/img-2.jpg" alt="" class="avatar-lg rounded-circle">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3 ">
                                <div class="user-info">
                    ...
                    <div class="swiper-slide border-radius">
                        ...
                        <div class="d-flex align-items-center mt-4 pt-3">
                            <div class="flex-shrink-0">
                                <div class="user-image">
                                    <img src="images/users/img-3.jpg" alt="" class="avatar-lg rounded-circle">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3 ">
                                <div class="user-info">
                    ...
                    <div class="swiper-slide border-radius">
                        ...
                        <div class="d-flex align-items-center mt-4 pt-3">
                            <div class="flex-shrink-0">
                                <div class="user-image">
                                    <img src="images/users/img-4.jpg" alt="" class="avatar-lg rounded-circle">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3 ">
                                <div class="user-info">
            ...
            <div class="row" id="counter">
                    ...
                    <div class="counter-box py-0 py-lg-5 text-center position-relative">
                        ...
                        <div class="py-5 pb-0">
                            <div class="counter-image">
                                <img src="images/counter/support.png" alt="">
                            </div>
                ...
                <div class="col-lg-3 p-lg-0">
                    <div class="counter-box py-0 py-lg-5 text-center">
                        <div class="py-5 pb-0">
                            <img src="images/counter/project-running.png" alt="">
                ...
                <div class="col-lg-3 p-lg-0">
                    <div class="counter-box py-0 py-lg-5 text-center side-border">
                        <div class="side-border-left"></div>
                        <div class="py-5">
                            <img src="images/counter/idea.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 d-none ">
                    <div class="price-save-box bg-primary p-4 mt-5 border-radius">
                        ...
                        <div class="price-image">
                            <img src="images/pricing/investment.png" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pricing-box box-shadow p-4 border-radius">
                        <div class="text-center mb-4">
                            ...
                            <div class="detail mt-4">
                                <p><span class="text-primary icon me-2">∎</span><del>10 GB Disk Space</del></p>
                                <p><span class="text-primary icon me-2">∎</span><del>1 Year Technical Support</del></p>
                                <p><span class="text-primary icon me-2">∎</span><del>SQL Database</del></p>
                                <p><span class="text-primary icon me-2">∎</span><del>Custom Domain</del></p>
                            </div>

                        </div>
                        <div class="text-center">
                            <a href="{{route('get-started', 'basic')}}" class="btn btn-primary rounded-pill   ">Get
                                started</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pricing-box box-shadow p-4 border-radius">
                        <div class="text-center mb-4">
                            ...
                            <div class="price-tag mt-4">
                                ...
                                <h4><del><span class="text-danger">₦ 20.9k</span></del></h4>
                                <h3><span class="text-primary">₦ 10k</span></h3>
                            </div>
                            <!-- <p class="text-muted mt-2">For small teams trying out Levonic <br> for an unlimited </p> -->

                            <div class="detail mt-4">
                                <p><span class="text-primary icon me-2">∎</span>2 GB Disk Space</p>
                                <p><span class="text-primary icon me-2">∎</span>1 Year Technical Support</p>
                                <p><span class="text-primary icon me-2">∎</span><del>Database Backup</del></p>
                                <p><span class="text-primary icon me-2">∎</span><del>Custom Domain</del></p>
                        ...
                        <div class="text-center">
                            <a href="{{route('get-started', 'starter')}}" class="btn btn-primary rounded-pill   ">Get
                                started</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3  mt-5">
                    <div class="pricing-box box-shadow p-4 border-radius border border-success shadow">
                        <div class="text-center mb-4">
                            <h6 class="text-primary">Standard</h6>
                           
                            <div class="price-tag mt-4">
                              
                                <h4><del><span class="text-danger">₦ 40.9k</span></del></h4>
                                <h3><span class="text-primary">₦ 19.9k</span></h3>
                            </div>
                            <!-- <p class="text-muted mt-2">For small teams trying out Levonic <br> for an unlimited </p> -->
                            ...
                            <div class="detail mt-4">
                                <p><span class="text-primary icon me-2">∎</span>2 GB Disk Space</p>
                                <p><span class="text-primary icon me-2">∎</span>1 Year Technical Support</p>
                                <p><span class="text-primary icon me-2">∎</span>Database Backup</p>
                                <p><span class="text-primary icon me-2">∎</span><del>Custom Domain</del></p>
                        ...
                        <div class="text-center">
                            <a href="{{route('get-started', 'standard')}}" class="btn btn-primary rounded-pill   ">Get
                                started</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3  mt-5">
                    <div class="pricing-box box-shadow p-4 border-radius">
                        <div class="text-center mb-4">
                            <h6 class="text-primary">Advanced</h6>
                           
                            <div class="price-tag mt-4">
                              
                                <h4><del><span class="text-danger">₦ 90.9k</span></del></h4>
                                <h3><span class="text-primary">₦ 50k</span></h3>
                            </div>
                            <!-- <p class="text-muted mt-2">For small teams trying out Levonic <br> for an unlimited </p> -->
                            ...
                            <div class="detail mt-4">
                                ...
                                <p><span class="text-primary icon me-2">∎</span>1 Year Technical Support</p>
                                <p><span class="text-primary icon me-2">∎</span>Database Backup</p>
                                <p><span class="text-primary icon me-2">∎</span>Custom Domain</p>

                            </div>

                        </div>
                        <div class="text-center">
                            <a href="{{route('get-started', 'advanced')}}" class="btn btn-primary rounded-pill   ">Get
                                started</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section faq" id="faq">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="images/faq/Questions.png" alt="" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-lg-4 col-md-6 mt-4 mt-2">
                    <div class="blog-image overflow-hidden">
                        <img src="images/blog/img-1.jpg" alt="" class="img-fluid w-100">
                    </div>
                ...
                <div class="col-lg-4 col-md-6  mt-4 mt-2">
                    <div class="blog-image overflow-hidden">
                        <img src="images/blog/img-3.jpg" alt="" class="img-fluid w-100">
                    </div>
